...
description: "How the engine reads handwritten student math using Gemini 2.5 Flash as primary OCR, escalating to Claude vision when confidence falls below 0.7."
---
