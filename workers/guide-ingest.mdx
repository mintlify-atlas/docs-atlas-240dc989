...
description: "SQS worker that extracts math questions from uploaded worksheet PDFs using Gemini precheck and Claude Sonnet, then publishes each question to the solution-generation queue."
---
