---
title: "llmClassifier: Async Error Classification Worker"
sidebarTitle: "LLM Classifier"
description: "SQS worker that classifies unclassified student attempts against a 2,600+ error taxonomy using Claude Haiku in batches of 20 with prompt caching and forced tool_use."
---
