...
description: "SQS worker that builds step-by-step solution keys for extracted guide questions using Claude Sonnet, then sets the guide to REVIEW status when complete."
---
