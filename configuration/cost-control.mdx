...
<Note>
  Haiku is **15× cheaper** on input tokens than Sonnet. This difference drives the model assignment strategy described below.
</Note>
...
|---|---|---|
| `llmClassifier` | `claude-haiku-4-5` | High-volume batch classification; Haiku is 15× cheaper on input and quality is sufficient for taxonomy matching. |
