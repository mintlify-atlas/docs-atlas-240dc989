...
description: "All environment variables accepted by Innova AI Engine, loaded via pydantic-settings, grouped by concern: API keys, database, AWS, guides pipeline, and alert thresholds."
---
